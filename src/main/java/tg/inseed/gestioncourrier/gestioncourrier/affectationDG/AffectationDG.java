package tg.inseed.gestioncourrier.gestioncourrier.affectationDG;
...
public class AffectationDG {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AffectationDG other = (AffectationDG) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        return "AffectationDG [id=" + id + ", courrier=" + courrier + ", utilisateur=" + utilisateur + ", direction="
