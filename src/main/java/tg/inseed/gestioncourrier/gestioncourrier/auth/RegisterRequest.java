...
/**
 * Représente les données nécessaires à l'enregistrement d'un nouvel utilisateur.
 * Cette classe est utilisée pour valider les informations envoyées par le client lors de la création de compte.
 * Elle applique des contraintes strictes pour garantir la qualité, la sécurité et la cohérence des données.
 */
...
public class RegisterRequest {
    ...
    /**
     * Rôle attribué à l'utilisateur dans le système.
     * Ce champ est obligatoire et doit correspondre à l'un des rôles métier autorisés :
     * ADMIN, DG, DIRECTION, SECRETARIAT, DIVISION, SERVICES.
     * La validation est assurée par une expression régulière pour éviter les rôles non reconnus.
     */
